function [settlingTime] = settlingTimeAnalysis(mc, mp, b, L, g, I)
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here

%mc = 1.135; %mass of cart [kg]
%mp = 0.2; %mass of pendulum [m]
...
assignin('base','x0',x0)
assignin('base','des_pole',des_pole)
assignin('base','K',K)
assignin('base','Q',Q)
assignin('base','R',R)
assignin('base','K_lqr',K_lqr)
assignin('base','Ts',Ts)
assignin('base','sys_disc',sys_disc)
assignin('base','Ad',Ad)
assignin('base','Bd',Bd)
assignin('base','Cd',Cd)
assignin('base','Dd',Dd)
assignin('base','des_pole_d',des_pole_d)
assignin('base','R',R)
%% Run Sim
